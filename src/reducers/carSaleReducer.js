...
export const carSaleReducer = (state = initialState, action) => {
    ...
    switch(action.type){
        ...
        case REMOVE_FEATURE:
            const peacedOutFeature = state.car.features.find(feature => feature.id === action.payload)
            return{
                ...state,
               additionalPrice: state.additionalPrice - peacedOutFeature.price,
               additionalFeatures: [...state.additionalFeatures, peacedOutFeature],
